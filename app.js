...
function selectCompany() {
  ...
  for (var brand in watches[companyselected]) {
    // console.log(brand)
    brandselect.innerHTML += `
    <option value= "${watches[companyselected][brand].name}">${watches[companyselected][brand].name}</option>`
...
function selectBrand() {
  brandselected = event.target.value
...
function searchProduct() {
  ...
  for (var key in watches[companyselected]) {
    if (watches[companyselected][key].name === brandselected) {
      productImage = watches[companyselected][key].img;
      console.log(productImage)

      var brandcolor = watches [companyselected][key].color;
  ...
  function backtomain(){
    document.getElementById('maindiv-1').classList.remove('d-none');
      document.getElementById('maindiv-2').classList.remove('d-none');
      document.getElementById('maindiv-3').classList.add('d-none');
  }
